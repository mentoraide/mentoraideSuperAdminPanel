    ...
    return (
        <>
            <Space direction="horizontal" className='search-box'>
                ...
                <Space className='responsive-wrap'>
                    <label htmlFor="user-name-field" style={{ fontSize: "small" }} >User Name : <QuestionCircleOutlined /> </label>
                    <Input placeholder="Basic usage" size='medium' id='user-name-field' />
                </Space>


                <Space className='responsive-wrap'>
                    <label htmlFor="college-name-field" style={{ fontSize: "small" }}>College :</label>
                    <Search
            ...
            <Space direction="horizontal" className='tools-box'>
                <Space>
                    <Typography.Text >Search Table</Typography.Text>
                </Space>
